  ...
  <DashboardLayout>
    <div class="p-6 max-w-4xl mx-auto">
      ...
      <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Create {{ postType?.singularLabel || 'Content' }}</h1>
      </div>
...
import type { FieldDefinition, CreateContentDto } from '../types/postTypes'
...
const handleSubmit = async () => {
  try {
    ...
    await contentStore.create(slug.value, dto)
