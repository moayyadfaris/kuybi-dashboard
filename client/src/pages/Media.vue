          ...
          <div class="p-4">
            ...
            <div class="flex gap-2 mt-4">
              <a
                ...
                class="flex-1 px-3 py-2 bg-orange-100 hover:bg-orange-200 text-orange-700 rounded text-xs font-medium text-center transition"
              >
                View
              </a>
              <button
                @click="deleteAttachment(attachment.id)"
                class="flex-1 px-3 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded text-xs font-medium transition"
              >
                Delete
              </button>
            </div>
